...
// Khởi tạo mảng các object Category (dùng ID làm key để dễ map)
$categoryObjects = [
    1 => new Category(1, 'Ban phim'),
    2 => new Category(2, 'Chuot'),
    3 => new Category(3, 'Man hinh')
];

// Khởi tạo mảng các object Product
$productObjects = [
